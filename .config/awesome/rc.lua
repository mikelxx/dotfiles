...
beautiful.init("/home/michal/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- Screenshots
    awful.key({}, "Print", function() awful.util.spawn("spectacle -rbc") end)
)
...
awful.spawn.with_shell("polybar --config=/home/michal/.config/polybar/config.ini bar")
awful.spawn.with_shell("picom")

gears.wallpaper.centered("/home/michal/Downloads/asnk06xoqzi61.jpg", nil, '#333', 1)
