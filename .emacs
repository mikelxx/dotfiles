...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (neotree indium smart-mode-line smart-mode-line-powerline-theme nodejs-repl multiple-cursors gruvbox-theme dracula-theme spacemacs-theme csharp-mode go-mode haskell-mode company magit gruber-darker-theme)))
